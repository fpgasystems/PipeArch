...
void FPGA_LRMF::UseCreatedMemoryLayout(FPGA_LRMF* baseObj) {
	...
	uint32_t numEpochs)
{
	...
	fit &= FPGA_Program::CheckMemoryFit(MEM_ACCESSPROPS_size, iFPGA::MEMORY_SIZE_IN_CL, "MEM_ACCESSPROPS");
	...
	fit &= FPGA_Program::CheckMemoryFit(MEM_LOCALPROPS_size, iFPGA::MEMORY_SIZE_IN_CL, "MEM_LOCALPROPS");
	...
	fit &= FPGA_Program::CheckMemoryFit(REGION_LABELS_size, iFPGA::MEMORY_SIZE_IN_CL, "REGION_LABELS");

	// REGION_MODEL
	uint32_t MtileOffsetInBRAM = 0;
	uint32_t REGION_MODEL_size = MtileOffsetInBRAM + m_tileSize*m_numFeaturesInCL;
	fit &= FPGA_Program::CheckMemoryFit(REGION_MODEL_size, iFPGA::MEMORY_SIZE_IN_CL, "REGION_MODEL");

	// REGION_INPUT
	uint32_t UtileOffsetInBRAM = 0;
	uint32_t REGION_INPUT_size = UtileOffsetInBRAM + m_tileSize*m_numFeaturesInCL;
	fit &= FPGA_Program::CheckMemoryFit(REGION_INPUT_size, iFPGA::MEMORY_SIZE_IN_CL, "REGION_INPUT");
	...
	fit &= FPGA_Program::CheckMemoryFit(REGION_PREFETCH_size, iFPGA::PREFETCH_BUFFER_SIZE_IN_CL, "REGION_PREFETCH");
