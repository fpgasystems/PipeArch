...
if args.shuffle == 1:
	file_name = args.features_dir + '/im_' + str(samples.shape[0]) + '_' + str(samples.shape[1]) + '_' + str(args.num_classes)
else:
	file_name = args.features_dir + '/im_' + str(samples.shape[0]) + '_' + str(samples.shape[1]) + '_' + str(args.num_classes) + '_nonshuffle'
